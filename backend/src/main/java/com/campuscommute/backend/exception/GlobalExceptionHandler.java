...
import com.campuscommute.backend.dto.common.ApiError;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(InvalidCollegeEmailException.class)
    public ResponseEntity<ApiError> handleInvalidEmail(InvalidCollegeEmailException ex, HttpServletRequest req) {
